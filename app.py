...
def get_file_content_as_string(path):    
    ...
    url = 'https://raw.githubusercontent.com/vortexheinz/kintaiyi-master/master/' + path
    ...
    with st_capture(output5.code):
        try:
            if manual:
                ...
                print("{} |\n農曆︰{} | {} |\n{} |\n{} |\n{} - {} - {} ({}) | \n積{}數︰{} | \n紀元︰{} | 主筭︰{}  客筭︰{}  定算︰{}  |\n{}禽值年 | {}門值事 | {}卦值年  |\n 陽九︰{} 百六︰{} |\n{}{}{}\n{} \n\n".format(ty.gendatetime(), lunard, ty.getjq(),gz, ty.kingyear(), ty.ty_method(tn), ty.taiyi_name(num), ty.kook(num, tn).get("文"),  ttext.get("局式").get("年"), ty.taiyi_name(num)[0],tynum, ttext.get("紀元"), homecal, awaycal, setcal, yc, ed, g, yj, bl, ty.ty_gong_dist(num, tn), ty.threedoors(num, tn), ty.fivegenerals(num, tn), ty.geteightdoors(num, tn) ))
        ...
        try:
            if manual1:
                ...
                st.title("史事記載︰")
                st.markdown(ch)
                print("{} |\n農曆︰{} | {} |\n{} |\n{} |\n{} - {} - {} ({}) | \n積{}數︰{} | \n紀元︰{} | 主筭︰{}  客筭︰{}  定算︰{}  |\n{}禽值年 | {}門值事 | {}卦值年  |\n陽九︰{} 百六︰{}\n\n".format(ty.gendatetime(),lunard, ty.getjq(), gz, ty.kingyear(), ty.ty_method(tn), ty.taiyi_name(num), ty.kook(num, tn).get("文"),  ttext.get("局式").get("年"), ty.taiyi_name(num)[0], tynum, ttext.get("紀元"), homecal, awaycal, setcal, yc, ed,g, yj, bl))
                expander = st.expander("原始碼")
                expander.write(str(ttext))
            else:
                st.empty()
